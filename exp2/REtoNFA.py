...
class ExpressionTree:
    ...
    def __init__ (self, _type:Type, value=None): 
        self._type = _type
        self.value = value 
        self.left = None 
        self.right = None
...
def postfix(regexp):
        temp=[]
    # adding dot "." between consecutive symbols temp = []
...
def printStateTransitions(state, states_done:list, symbol_table): 
...
r = input("Enter regex: ") 
pr = postfix(r)
et = constructTree(pr) #inorder(et)
fa = evalRegex(et) 
